package com.tutorial;
   ...
   class Segitiga extends BangunDatar{
    ...
    public Segitiga(float alas, float tinggi, float sisi1, float sisi2, float
     ...
     public void display(){
        System.out.println("Segitiga dengan alas:" + alas + ",tinggi:" + tinggi + ",dan panjang sisi-sisi:" + sisi1 + sisi2 + sisi3);
     }
...
public class Main {
    public static void main(String[] args) {
        ...
        Segitiga segitiga = new Segitiga(6.0f, 7.0f, 5.0f, 4.0f, 5.0f);
        segitiga.display();
